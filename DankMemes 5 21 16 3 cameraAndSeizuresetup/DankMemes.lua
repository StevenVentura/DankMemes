...
AddDankOption("option_KBSeizure","KBSeizure","Give the user a seizure when he gets a KB on a player.",5);
...
seizureFrameObj = seizureFrame:CreateTexture("ARTWORK");
 ...
 tex:SetTexture(0.1686274509803922,0.0588235294117647,0.003921568627451); tex:SetAlpha(0.20);
seizureFrame:Show();
...
--down here is the NPC kill section
