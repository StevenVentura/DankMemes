...
option_pepeDeath = CreateFrame("CheckButton","option_pepeDeath",DankOptionsPanel,"OptionsCheckButtonTemplate");
_G[option_pepeDeath:GetName() .. "Text"]:SetText("Sad Pepe");
option_pepeDeath:SetScript("OnEnter", function(self)
	GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
	GameTooltip:SetText("Show crying Pepe when you die");
end);
option_pepeDeath:SetPoint("TOPLEFT",20,-20);
option_pepeDeath.setFunc = function(value) 
DankOptions["option_pepeDeath"] = value == "1"
end

--now load saved options
option_pepeDeath:SetChecked(DankOptions["option_pepeDeath"]);
