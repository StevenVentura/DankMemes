...
AddDankOption("option_marioJump","Mario Jump","Play SNES Mario jump soundfile when you jump",3);
AddDankOption("option_youveGotMail","Got Mail","Play AOL-themed 'Youve Got Mail' when loading finishes",4);
...
spellCaster, spellName, _, spellCount = ...;
if (spellName == "Starfire" and DankOptions["option_spartanLaser"] == true) then
if (LaserNoiseHandle ~= nil) then StopSound(LaserNoiseHandle); end;--stop the charging noise
