...
timerHaloShieldSound = 0;
function manageHaloShieldNoises(elapsed)
if (HaloShieldFrame.SHIELD_IS_BROKEN == false) then return end;

if (DankOptions["option_shieldBreak"] == true) then
...
HaloShieldFrame.SHIELD_IS_BROKEN = false;--this is how i turn on the noises.
