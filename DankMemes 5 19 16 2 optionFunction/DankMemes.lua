...
local currentOptionsRow = -1;
function AddDankOption(name,label,desc)
currentOptionsRow = currentOptionsRow + 1;
...
option_temp:SetPoint("TOPLEFT",20,currentOptionsRow*(-20)-20);
...
AddDankOption("option_pepeDeath","Sad Pepe","Show crying Pepe when you die");
AddDankOption("option_haloMultikill","MultiKill Medals", "Show Halo Multikill medals when you kill players");
