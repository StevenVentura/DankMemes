...
dankSnoopImage:SetPoint('CENTER', 0,0);
dankSnoopImage:SetFrameStrata("HIGH");
dankSnoopImage:SetSize(800,800);
...
dankSnoopImage.TIMER_MAX = 250 / 500;--when it should go to the next image
--
